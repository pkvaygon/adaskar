        ...
        <div className="flex justify-center items-center gap-8 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full">
            {
                categoryItems.map((category, index) => (
                    <Link href={'/search-ads' + '?' + createQueryString('category', category.slug)} key={index} className="px-2 transition-background py-4 rounded-lg hover:bg-violet-500 flex justify-center items-center gap-2">
